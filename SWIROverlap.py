...
def Vein_SWIR_Threshold(SWIR_dir, vein_mask, tubeID, min_area=100):
    ...
    if loaded_SWIR_tube is not None:
        ...
        hyperspectral_values_vein = hyperspectral_resize_RGB[vein_mask == 255]
        ...
        overlap_vein_RGBandSWIR = cv2.bitwise_and(thresholded_hyperspectral, vein_mask)
        
        additional_vein_RGBandSWIR = cv2.subtract(thresholded_hyperspectral, vein_mask)
